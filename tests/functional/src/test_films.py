...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            {"status": HTTPStatus.UNPROCESSABLE_ENTITY, "length": None},
        ),
        (
        ...
        (
            ...
            {"status": HTTPStatus.UNPROCESSABLE_ENTITY, "length": 20},
        ),
    ],
)
...
async def test_film(
    ...
    # 1. Поиск в ES
    data = await es_get_data(index=test_settings.es_index_movies, **query_data)
